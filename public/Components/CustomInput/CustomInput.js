...
class CustomInput extends Component {
    ...
    render() {
        ...
        return (
            <View>
                {mode === 'password' ?
                    <TouchableOpacity style={styles.btn_visible} onPress={this.onPressIsVisiblePassword}>
                        <Image style={styles.btn_visible_ic} source={!isVisiblePassword ? ic_eye : ic_off_eye} />
                    </TouchableOpacity>
                    :
                    null
                }
