...
import { View, ScrollView, Image, TouchableOpacity, Share, Switch } from 'react-native';
                    ...
                    >
                        ...
                        >
                            <View style={styles.row_right}>
                                <Image style={styles.row_right_ic} source={item.icon} />
                            </View>
                            ...
                            <View style={styles.row_left}>
                                <Image style={styles.row_left_ic} source={ic_arrow} />
                            </View>
                        </View>
                    </TouchableOpacity>
                ))
