...
import { View, ImageBackground, StatusBar, BackHandler, I18nManager, Alert, Platform } from 'react-native';
...
class SignUp extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            confirmPass: '',
            introCode: '',
            // email: 'pouria.khazaei.95@gmail.com',
            // password: "12345678",
    ...
    onPressSignUp = () => {
        ...
        const emailCheck = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;//Regular Expression
        if (!email) {
