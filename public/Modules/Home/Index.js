...
import { View, StatusBar, Image, Dimensions, Alert } from 'react-native';
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.header}>
                    <Image style={styles.header_img} source={logo_long} />
                </View>
                <View style={styles.center}>
                    <View style={{ width: width, flex: 1.5 }}>
                        <Slider />
                    </View>
                    <View style={[styles.center_row, { marginTop: 5 }]}>
                        <BoxButton
                            style={{ marginRight: 5 }}
