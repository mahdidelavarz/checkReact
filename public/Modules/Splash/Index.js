...
import { View, ActivityIndicator, StatusBar, Image, Alert, TouchableOpacity } from 'react-native';
        ...
        return (
            <View style={styles.container}>
                ...
                <Animatable.View
                    ...
                    animation="zoomIn"
                    duration={1500}>
                    <Image style={styles.center_logo} source={log} />
                </Animatable.View>
                {!isBtnRetry ?
                    ...
                    :
                    <View style={styles.top}>
                        <TouchableOpacity style={styles.btn_retry} onPress={this.onPressRetryDownloadJson}>
                            <CustomText font_weight={'bold'} style={styles.btn_retry_txt}>تلاش مجدد</CustomText>
                        </TouchableOpacity>
                    </View>
                }
                <View style={styles.bottom}>
                    <Image style={styles.bottom_img} source={happy_boy} resizeMode='center' />
                </View>
            </View>
        );
    }
