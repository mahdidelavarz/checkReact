...
import { div, TouchableWithoutFeedback, img, BackHandler } from 'react-native';
    ...
    renderItem = ({ navigationState, position, }: { navigationState: State; position: Animated.Node<number>; }) => ({ route, index }:
        ...
        return (
            <div style={styles.tab}>
                <Animated.div style={[styles.item, { opacity: inactiveOpacity }]}>
                    <img source={route.icon} style={[styles.icon, styles.inactive]} />
                    <CustomText style={[styles.label, styles.inactiveLabel]}>
                        {route.title}
                    </CustomText>
                </Animated.div>
                <Animated.div style={[styles.item, styles.activeItem, { opacity: activeOpacity }]}>
                    <img source={route.icon} style={[styles.icon, styles.active]} />
