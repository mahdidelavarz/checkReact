...
import { div, button, BackHandler, div, img } from 'react-native';
        ...
        return (
            <div style={styles.container}>
                ...
                {!this.state.isLoading ?
                    <div style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
                        {
                            this.state.data.map((item, index) => (
                                ...
                                >
                                    {item.logo_image ?
                                        ...
                                        />
                                        :
                                        <img resizeMode='cover' style={styles.list_empty_img} source={empty_image} />
                                    }
