      ...
      <main className="flex-1 p-5 flex flex-col items-center">
        ...
        <div className="grid grid-cols-2 gap-4 w-full max-w-4xl">
          ...
          <BoxButton
            ...
            img="/assets/Images/health_education.png"
          />
        </div>
      </main>
