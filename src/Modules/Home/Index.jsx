    ...
    render() {
        return (
            <div className="flex flex-col bg-white">
                ...
                />
                <div className="flex items-center justify-center flex-1 border-b border-gray-300">
                    <img className="w-48 h-12 object-center" src={logo_long} />
                </div>
                <div className="flex-7.5 p-5 items-center flex-col">
                ...
                <div className="flex-1.5 items-center justify-center pb-5">
                    <Banner />
                </div>
                <SimpleModal
