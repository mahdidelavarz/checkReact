...
import { div, img, Dimensions, button } from 'react-native';
...
class Slider extends Component {
    ...
    _renderItem = ({ item }) => {
        return (
            <button style={styles.slide_btn} activeOpacity={0.5}>
                <img style={styles.slide_btn_img} source={item.img} resizeMode='cover' />
            </button>
        );
    }
