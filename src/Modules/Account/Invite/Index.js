...
import { ImageBackground, StatusBar, BackHandler, button, img, div, div, Share } from 'react-native';
...
function Invite(props) {
    ...
    return (
        <ImageBackground style={styles.container} source={inviteBack}>
            ...
            <div style={styles.flex_up}>
                <button
                    style={styles.flex_up_btn_back}
                    activeOpacity={0.7}
                    onPress={backAction}
                >
                    <img style={styles.flex_up_btn_back_ic} source={ic_back} />
                </button>
            </div>
            <div style={styles.flex_center}>
                <div style={styles.flex_center_up} />
                <div style={styles.flex_center_down}>
                    <CustomText font_weight={'bold'} style={styles.flex_center_down_userName_txt}>
                        {userName}
                    </CustomText>
                    <div style={styles.flex_center_down_scroll} showsVerticalScrollIndicator={false}>
